...
struct SignInOverlayView: View {
    ...
    private var continuingText: String {
        switch language {
        case "it": return "Continuando accetti le condizioni di MyWellness"
        case "es": return "Al continuar aceptas los términos de MyWellness"
        case "de": return "Du stimmst den Bedingungen von MyWellness zu"
        case "fr": return "En continuant vous acceptez les conditions"
        case "pt": return "Ao continuar você aceita os termos de MyWellness"
        default:   return "By continuing you accept MyWellness"
        }
    }
